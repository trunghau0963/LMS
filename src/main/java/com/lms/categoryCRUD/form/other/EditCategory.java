...
public class EditCategory extends javax.swing.JDialog {
    ...
    public EditCategory(javax.swing.JInternalFrame parent, javax.swing.JFrame owner, boolean modal,
        ...
        category = categoryList.getSelectCategory();
        categoryID.setText(category.getId());
        gerneName.setText(category.getGenre());
    }
    ...
    private void initComponents() {
        ...
        gerneName = new javax.swing.JTextField();
        ...
        jPanel12.setPreferredSize(new java.awt.Dimension(800, 200));
        ...
        layout.setVerticalGroup(
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addComponent(jPanel1, javax.swing.GroupLayout.PREFERRED_SIZE, 390,
                                javax.swing.GroupLayout.PREFERRED_SIZE));
    ...
    private void saveButton1ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_saveButton1ActionPerformed
        ...
        if (name.equals("")) {
            ...
            try {
                ...
                categoryModel.setId(categoryID.getText());
                categoryModel.setGenre(name);
                categoryService.editCategory(categoryModel);
                this.dispose();
                categoryList.loadDataToTable(categoryService.getAllCategories());
                JOptionPane.showMessageDialog(this, "Edit category successfully !", "Success",
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditCategory.class.getName()).log(java.util.logging.Level.SEVERE, null,
                    ex);
    ...
    private javax.swing.JTextField gerneName;
