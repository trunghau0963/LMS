 ...
 * @author Van Vinh
 */
public class EditInfoAuthor extends javax.swing.JFrame {

    /**
     * Creates new form NewPublisher
     */
    public EditInfoAuthor() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditInfoAuthor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditInfoAuthor().setVisible(true);
            }
        });
    }
