...
public class AddPublisher extends javax.swing.JDialog {
    ...
    public AddPublisher(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }

    public AddPublisher(javax.swing.JInternalFrame parent, javax.swing.JFrame owner, boolean modal, PublisherService service) {
        super(owner, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        stateChoose.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Hide", "Unhide", " ", " " }));
    ...
    private void saveButton1ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_saveButton1ActionPerformed
        ...
        if (name.equals("") || address.equals("") || state.equals("")) {
            ...
            try {
                publisherService.addPublisher(name, address, state);
                this.dispose();
                publisherList.loadDataToTable(publisherService.getListPublishers());
                JOptionPane.showMessageDialog(this, "Add Publisher successfully !");
            } catch (Exception e) {
                JOptionPane.showMessageDialog(this, "Add Publisher failed !", "Error", JOptionPane.ERROR_MESSAGE);
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddPublisher.class.getName()).log(java.util.logging.Level.SEVERE, null,
                    ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AddPublisher dialog = new AddPublisher(new javax.swing.JFrame(), true);
