...
public class CategoryJFrame extends javax.swing.JFrame {
    private static ListBookCategory listCategory;
    ...
    public CategoryJFrame() {
        initComponents();
        listCategory = new ListBookCategory();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CategoryJFrame.class.getName()).log(java.util.logging.Level.SEVERE, null,
                    ex);
