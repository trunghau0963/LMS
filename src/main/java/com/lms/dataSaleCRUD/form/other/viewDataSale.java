...
public class viewDataSale extends javax.swing.JFrame {
    public viewDataSale() {
        ...
        double[] revenueArray1 = new double[] { books.get(0).getTotal_revenue(), books.get(1).getTotal_revenue(),
                books.get(2).getTotal_revenue(), books.get(3).getTotal_revenue(), books.get(4).getTotal_revenue(),
        ...
        chart2.addData(new ModelChart(getInitials(categories.get(0).getGenre()), new double[] { revenueArray2[0] }));
        chart2.addData(new ModelChart(getInitials(categories.get(1).getGenre()), new double[] { revenueArray2[1] }));
        chart2.addData(new ModelChart(getInitials(categories.get(2).getGenre()), new double[] { revenueArray2[2] }));
        chart2.addData(new ModelChart(getInitials(categories.get(3).getGenre()), new double[] { revenueArray2[3] }));
        chart2.addData(new ModelChart(getInitials(categories.get(4).getGenre()), new double[] { revenueArray2[4] }));
        chart2.addData(new ModelChart(getInitials(categories.get(5).getGenre()), new double[] { revenueArray2[5] }));

        chart3.addLegend("Revenue", new Color(255, 165, 0));
        chart3.addData(new ModelChart(getInitials(customers.get(0).getName()), new double[] { revenueArray3[0] }));
        chart3.addData(new ModelChart(getInitials(customers.get(1).getName()), new double[] { revenueArray3[1] }));
        chart3.addData(new ModelChart(getInitials(customers.get(2).getName()), new double[] { revenueArray3[2] }));
        chart3.addData(new ModelChart(getInitials(customers.get(3).getName()), new double[] { revenueArray3[3] }));
        chart3.addData(new ModelChart(getInitials(customers.get(4).getName()), new double[] { revenueArray3[4] }));
        chart3.addData(new ModelChart(getInitials(customers.get(5).getName()), new double[] { revenueArray3[5] }));

        chart4.addLegend("Revenue", new Color(128, 128, 128));
        chart4.addData(new ModelChart(getInitials(employees.get(0).getName()), new double[] { revenueArray4[0] }));
        chart4.addData(new ModelChart(getInitials(employees.get(1).getName()), new double[] { revenueArray4[1] }));
        chart4.addData(new ModelChart(getInitials(employees.get(2).getName()), new double[] { revenueArray4[2] }));
        chart4.addData(new ModelChart(getInitials(employees.get(3).getName()), new double[] { revenueArray4[3] }));
        chart4.addData(new ModelChart(getInitials(employees.get(4).getName()), new double[] { revenueArray4[4] }));
        chart4.addData(new ModelChart(getInitials(employees.get(5).getName()), new double[] { revenueArray4[5] }));
    }
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addGroup(layout.createSequentialGroup()
                                                .addGroup(layout
                                                        ...
                                                        .addComponent(chart3, javax.swing.GroupLayout.DEFAULT_SIZE, 439,
                                                                Short.MAX_VALUE))
                                                .addGap(18, 18, 18)
                                                .addGroup(layout
                                                        .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING,
                                                        ...
                                                        .addComponent(btn4, javax.swing.GroupLayout.DEFAULT_SIZE,
                                                                javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                                        .addComponent(chart4, javax.swing.GroupLayout.DEFAULT_SIZE, 439,
                                                                Short.MAX_VALUE))
                                                .addGap(25, 25, 25))
                                        .addGroup(layout.createSequentialGroup()
                                                .addGroup(layout
                                                        .createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING,
                                                                false)
                                                        .addComponent(chart1, javax.swing.GroupLayout.Alignment.LEADING,
                                                ...
                                                .addGroup(layout
                                                        ...
                                                        .addComponent(btn2, javax.swing.GroupLayout.DEFAULT_SIZE,
                                                                javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                                        .addComponent(chart2, javax.swing.GroupLayout.DEFAULT_SIZE, 439,
                                                                Short.MAX_VALUE))
        ...
        layout.setVerticalGroup(
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addComponent(chart2, javax.swing.GroupLayout.PREFERRED_SIZE, 327,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(chart1, javax.swing.GroupLayout.PREFERRED_SIZE, 327,
                                                javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(18, 18, 18)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED,
                                        javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addComponent(chart4, javax.swing.GroupLayout.Alignment.TRAILING,
                                                javax.swing.GroupLayout.PREFERRED_SIZE, 327,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(chart3, javax.swing.GroupLayout.Alignment.TRAILING,
                                                javax.swing.GroupLayout.PREFERRED_SIZE, 327,
                                                javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addContainerGap()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(viewDataSale.class.getName()).log(java.util.logging.Level.SEVERE, null,
                    ex);
