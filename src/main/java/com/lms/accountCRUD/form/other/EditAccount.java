...
public class EditAccount extends javax.swing.JDialog {
        ...
        public EditAccount(javax.swing.JInternalFrame parent, javax.swing.JFrame owner, boolean modal, String title,
                        AdminService adminService, String role) throws ParseException {
                super(owner, modal);
                initComponents();
                ...
                if (parent instanceof AdminList) {
                        ...
                        admin = adminList.getSelectAdmin();
                        IdField.setText(admin.getAdminId());
                        ...
                        SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd");
                        Date dob = (Date) dateFormat.parse(employee.getDob());
                        jDateChooser3.setDate(dob);
                }
        ...
        private void initComponents() {
                ...
                jPanel18Layout.setHorizontalGroup(
                                jPanel18Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                .addComponent(jLabel15, javax.swing.GroupLayout.DEFAULT_SIZE, 398,
                                                                Short.MAX_VALUE));
        ...
        public static void main(String args[]) {
                ...
                try {
                        ...
                        java.util.logging.Logger.getLogger(EditAccount.class.getName()).log(
